    ...
    <div class="container mx-auto px-4">
          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
              <div class="flex items-center">
                ...
                <a href="{{ route('blogs') }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-soft-blue transition-colors md:ml-2">Blog</a>
              </div>
            </li>
            <li aria-current="page">
              <div class="flex items-center">
                ...
                <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 truncate max-w-[200px]">{{ $post->title }}</span>
              </div>
            </li>
          </ol>
        </nav>
      ...
      <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="w-full lg:w-8/12">
          ...
          <div class="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100">
            <div class="aspect-video relative">
              <img 
                src="{{ Storage::url($post->image_url)  ?? '/img/blog-placeholder.jpg' }}" 
                alt="{{ $post->title }}" 
            ...
            <div class="p-6">
              ...
              <div class="prose max-w-none">
                <h3 class="text-xl font-semibold mb-3 text-gray-800">Article</h3>
          ...
          <div class="mt-8 grid md:grid-cols-2 gap-6">
            <div class="bg-blue-50 border-l-4 border-soft-blue rounded-xl p-5 shadow-sm">
              ...
              <p class="text-blue-700">
                Remember to apply security best practices in your daily digital life. Update your software regularly and use strong, unique passwords for all your accounts.
              </p>
            </div>
            ...
            <div class="bg-green-50 border-l-4 border-green-600 rounded-xl p-5 shadow-sm">
              ...
              <p class="text-green-700">
                Keep up with the latest cybersecurity news and trends. Knowledge is the best defense against evolving digital threats.
              </p>
            </div>
          </div>
          ...
          <div class="mt-8 bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <h3 class="text-lg font-semibold mb-4 text-gray-800">Share This Article</h3>
            <div class="flex flex-wrap gap-3">
              ...
              <a 
                href="mailto:?subject={{ urlencode('Check out this article: ' . $post->title) }}&body={{ urlencode('I thought you might find this interesting: ' . request()->url()) }}" 
        ...
        <div class="w-full lg:w-4/12">
          ...
          <div class="bg-white rounded-2xl overflow-hidden shadow-sm p-6 border border-gray-100">
            ...
            <div class="space-y-5">
              @forelse ($relatedPosts as $relatedPost)
                <a href="{{ route('blogs.show', $relatedPost->id) }}" class="block group hover:bg-blue-50 rounded-xl p-3 transition-colors">
                  <div class="flex gap-3 items-start">
                    <div class="w-1/3 relative aspect-video rounded-lg overflow-hidden bg-gray-100 shadow-sm border border-gray-100">
                      <img 
                        src="{{ Storage::url($relatedPost->image_url) ?? '/img/blog-placeholder.jpg' }}" 
                    ...
                    <div class="w-2/3">
                      ...
                      <p class="text-xs text-gray-500 line-clamp-2 mb-2">
                        {{ \Illuminate\Support\Str::limit(strip_tags($relatedPost->content), 70) }}
                      </p>
              ...
              @empty
                <div class="text-center py-8 bg-gray-50 rounded-xl">
                  ...
                  <p class="text-gray-500 mb-2">No related articles available.</p>
                  <a href="{{ route('blogs') }}" class="text-soft-blue hover:text-blue-700 text-sm font-medium inline-flex items-center">
                    Browse all articles
          ...
          <!-- Add "Popular Articles" section for more content -->
          <div class="mt-6 bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100">
            ...
            <div class="p-6">
              <div class="space-y-4">
                @foreach(\App\Models\Blog::orderBy('views', 'desc')->take(3)->get() as $popularPost)
                  @if($popularPost->id != $post->id)
                    <a href="{{ route('blogs.show', $popularPost->id) }}" class="flex items-center gap-3 group hover:bg-blue-50 p-2 rounded-lg transition-colors">
